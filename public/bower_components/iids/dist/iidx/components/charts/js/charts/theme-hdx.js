define([
  ...
  'brandkit'
    ...
    var clrs = $.map(brandkit.accentPalette, function(val, key) { return val; });
    //shifting the first element to the end in the color palette
    var first = clrs[0];
    clrs = clrs.slice(1);
    clrs.push(first);
    ...
    title: {
      ...
      style: {
        color: brandkit.typography.textColor,
        fontFamily: brandkit.typography.brandFontFamily,
        fontWeight: 'bold',
        fontSize: brandkit.typography.baseFontSize
      }
    },
