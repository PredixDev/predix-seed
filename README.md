...
On October 6, 2016 this project was switched to a new implementation that uses Polymer instead of AngularJS.  For the previous implementation in AngularJS please refer to the 'develop-angular' and/or 'master-angular' branches.
